...
const Games: NextPage = () => {
		return (
				<Container>
						<PageHeaderComponent
								title="Hero Quest: Barbarian"
								text="The barbarian, the greatest warrior of all. But beware of magic for your sword is no defence against it."
